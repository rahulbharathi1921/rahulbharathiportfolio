  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl border-b border-primary/5">
      <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
        ...
        <Magnetic>
          <a
            href="mailto:rahulbharathi1921@gmail.com"
            className="bg-primary text-on-primary font-headline px-6 py-2 rounded-sm text-sm font-bold tracking-tight shadow-lg shadow-primary/15 hover:scale-105 transition-all inline-block"
          >
            CONTACT
          </a>
        </Magnetic>
